...
public enum CallbackQueryText {
    ...
    ZNO_PPO_TEXT("1) sd.nitec.kz\n\n" +
            ...
            "   Описание: \n<b>Прошу провести ЗНО в части ППО</b> (в Арм ЦОН или Арм СЦОН нужно уточнять)\n\n" +
            "3.2) КЕ\n" +
    ...
    FAQ_TEXT2("\uD83D\uDC49 Сколько стоит Торговый Робот от HASH7?\n" +
            "\n" +
            "Ответ:\n" +
            "\n" +
            "\uD83D\uDC49 На текущий момент стоимость лицензии 140 USDT в год.\n" +
            "\n" +
            "⚠\uFE0F Оплата производится только за годовую подписку.\n" +
            "\n" +
            "\uD83D\uDCBC Минимальный депозит для начала торговли с роботом – от 500 USDT.\n" +
            "\n" +
            "\uD83D\uDD25 Важно: цена на робота скоро вырастет! Успейте приобрести подписку по выгодной цене!"),

    FAQ_TEXT3("\uD83D\uDC49 Сколько я смогу зарабатывать?\n" +
            "\n" +
            "❓ Какую прибыль можно ожидать с робота?\n" +
            "\n" +
            "✅ В среднем, доходность робота HASH7 составляет от 10 до 30%% в месяц от вашего депозита.\n" +
            "\n" +
            "\uD83D\uDCC8 На растущем рынке возможен доход до 65%% в месяц!\n" +
            "\n" +
            "\uD83D\uDCA1 Мы рекомендуем не выводить сразу всю прибыль, а реинвестировать её обратно в торговлю. Благодаря эффекту сложного процента, ваш капитал будет расти гораздо быстрее! \uD83D\uDE80\uD83E\uDD29"),

    FAQ_TEXT4("\uD83D\uDC49 Насколько это безопасно?\n" +
            "\n" +
            "❓ Безопасна ли работа с роботом?\n" +
            "\n" +
            "✅ Все ваши средства находятся только на вашем личном счете на бирже, и только у вас есть доступ к ним.\n" +
            "\n" +
            "❌ Никакого доверительного управления\n" +
            "❌ Никаких брокеров\n" +
            "❌ Никакой передачи средств третьим лицам\n" +
            "\n" +
            "⚠\uFE0F Вы можете вывести депозит и прибыль в любое время по вашему желанию."),

    FAQ_TEXT5("\uD83D\uDC49 Как часто я могу выводить прибыль?\n" +
            "\n" +
            "✅ Вы можете выводить свои средства с биржи в любое время, хоть несколько раз в день!\n" +
            "\n" +
            "\uD83D\uDC49 Это касается как депозита, так и прибыли.\n" +
            "\n" +
            "\uD83D\uDD25 Ваш депозит НЕ замораживается даже тогда, когда робот активно торгует."),
